 ...
 * from the specification file <tt>/home/ST0270/Documents/ejemplo3/270172w7/w7/src/main/jflex/lexer.jflex</tt>
 */
public class W7Lexer implements java_cup.runtime.Scanner {
...
public void setCadena(String x){
   ...
   */
  public W7Lexer(java.io.Reader in) {
    this.zzReader = in;
  }
